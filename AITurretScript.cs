                ...
                if (turretType == "CIWS") {
                    ...
                    if (bx.GetComponent<MissileTrackerAndResponse> () != null) {
                        ...
                        if (bx.GetComponent<MissileTrackerAndResponse> ().MainObject != null) {
                            Target = bx.GetComponent<MissileTrackerAndResponse> ().MainObject;
                        }
                    } else {
            ...
            if (Target != null) {
                if (TurretBody != null && TurretAim != null) {
                    ...
                    if (currentTargetIndex != -1 && TargetListTemp.Targets[currentTargetIndex] != null &&
                        TargetListTemp.Targets[currentTargetIndex].GetComponent<MissileTrackerAndResponse> ().EngineController != null
                    ) {
                        V = TargetListTemp.Targets[currentTargetIndex].GetComponent<MissileTrackerAndResponse> ().EngineController.CurrentVel;
                    } else if (currentTargetIndex != -1 && TargetListTemp.Targets[currentTargetIndex] != null &&
                        TargetListTemp.Targets[currentTargetIndex].GetComponent<MissileTrackerAndResponse> ().AI != null && TargetListTemp.Targets[currentTargetIndex].GetComponent<MissileTrackerAndResponse> ().AI.AIRigidBody != null) {
                        V = TargetListTemp.Targets[currentTargetIndex].GetComponent<MissileTrackerAndResponse> ().AI.AIRigidBody.velocity;
                    } else {
                        V = Vector3.zero;
                    }
